...
This is a grilling session inverted. In ideation, the question was "what are you actually noticing?" Here it's "what is this article actually arguing, and in what order does the reader need to hear it?" Push back. Refuse to let weak transitions slide. If a beat doesn't earn its place, cut it.

Specific moves to keep using:

- "What does this beat do for the reader that the previous one didn't?"
